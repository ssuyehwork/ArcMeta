...
void CategoryPanel::initUi() {
    ...
    // 2026-05-17 按照用户要求：在“刷新分类”按钮左侧新增一个开关切换按钮
    // 2026-06-xx 物理增强：实现状态持久化加载 (方案 A)

    // 2026-06-xx 按照用户要求：从状态栏迁移至此，执行刷新分类
    ...
    btnRescan->setProperty("tooltipText", "刷新分类");
