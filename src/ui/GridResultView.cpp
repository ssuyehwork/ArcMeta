...
class GridThumbnailDelegate : public QStyledItemDelegate {
public:
    explicit GridThumbnailDelegate(QObject* parent = nullptr) : QStyledItemDelegate(parent) {}
...
GridResultView::GridResultView(QWidget* parent) 
    ...
    auto* delegate = new GridThumbnailDelegate(this);
