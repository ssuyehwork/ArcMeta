...
struct RuntimeMeta {
    ...
    RuntimeMeta() : rating(0), pinned(false), encrypted(false), isFolder(false), isTrash(false), isInvalid(false), isManaged(false), width(0), height(0), ingestionStatus(-2), ctime(0), mtime(0), atime(0), fileSize(0) {}
