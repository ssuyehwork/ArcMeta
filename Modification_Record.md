...
[2026-11-16 11:30:00]
- **任务描述**: 规范化“扫描入库”右键菜单职责，优化菜单文本描述，修复路径匹配 Bug 并补全 USN 同步逻辑。
- **修改文件**:
    - **修改**: `src/ui/ContentPanel.cpp` (重构 `ActionAddToCategory` 逻辑；优化菜单文本为“重新扫描”；删除未使用变量)
...
- **修改原因**:
    ...
    2. 优化 UI 文本冗余，将已入库项的“重新扫描入库”精简为“重新扫描”。
